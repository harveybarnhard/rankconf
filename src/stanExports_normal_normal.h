...
namespace model_normal_normal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_normal_normal");
    reader.add_event(20, 18, "end", "model_normal_normal");
    return reader;
}
#include <stan_meta_header.hpp>
class model_normal_normal
  : public stan::model::model_base_crtp<model_normal_normal> {
private:
        int n;
        std::vector<double> y;
        std::vector<double> sigma;
public:
    model_normal_normal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_normal_normal_namespace::model_normal_normal";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_normal_normal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_normal_normal_namespace::model_normal_normal stan_model;
#ifndef USING_R
